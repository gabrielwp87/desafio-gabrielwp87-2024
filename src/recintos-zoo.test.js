...
describe('Recintos do Zoologico', () => {
    ...
    test('Deve encontrar recinto para 2 crocodilo', () => {
    ...
    test('Não deve encontrar recintos para 3 crocodilo', () => {
    ...
    test('Não deve encontrar recintos para 3 leopardo', () => {
        const resultado = new RecintosZoo().analisaRecintos('LEOPARDO', 3);
        expect(resultado.erro).toBe("Não há recinto viável");
        expect(resultado.recintosViaveis).toBeFalsy();
    });

    test('Não deve encontrar recintos para 4 leopardo', () => {
        const resultado = new RecintosZoo().analisaRecintos('LEOPARDO', 4);
        expect(resultado.erro).toBe("Não há recinto viável");
        expect(resultado.recintosViaveis).toBeFalsy();
    });

    test('Não deve encontrar recintos para 5 leopardo', () => {
        const resultado = new RecintosZoo().analisaRecintos('LEOPARDO', 5);
        expect(resultado.erro).toBe("Não há recinto viável");
        expect(resultado.recintosViaveis).toBeFalsy();
    });

    test('Não deve encontrar recintos para 6 leopardo', () => {
